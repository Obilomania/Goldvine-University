...
namespace Goldvine_University.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(IUnitOfWork unitOfWork, UserManager<AppUser> userManager, ApplicationDbContext context)
        {
        ...
        public IActionResult Index()
        {
            ...
            {
                var role = userRole.FirstOrDefault(u => u.UserId == user.RoleId);
                if (role == null)
                {
                    user.Role = "None";
                }
